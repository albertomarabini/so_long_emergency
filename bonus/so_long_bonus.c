...
/*   Updated: 2023/08/03 22:58:25 by amarabin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	free_images(t_game *game)
{
	...
	free_image(game->mlx, game->imgs.deb);
}
...
static t_game	*init_game(char *file)
{
	...
	game->colls = 0;
	game->vills = 0;
	game->start = malloc(sizeof(struct timespec));
...
int	main(int argc, char **argv)
{
	...
	if (game == NULL)
		return (1);
	return (out(strdup("Goodbye!"), NULL, game));
	free_game(game);
}
